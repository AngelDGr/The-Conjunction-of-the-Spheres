...
public class TCOTS_BiomeTagGenerator extends BiomeTagsProvider {
    ...
    protected void addTags(final HolderLookup.@NotNull Provider arg) {
        ...
        //Has_Flora
        {
            this.tag(TCOTS_Tags.Biome.CELANDINE_SPAWN)
            ...
            this.tag(TCOTS_Tags.Biome.VERBENA_SPAWN)
                    .add(Biomes.PLAINS).add(Biomes.MEADOW)
                    .add(Biomes.BIRCH_FOREST).add(Biomes.OLD_GROWTH_BIRCH_FOREST).add(Biomes.FOREST).add(Biomes.DARK_FOREST)
                    .add(Biomes.FLOWER_FOREST)
            ;

            this.tag(TCOTS_Tags.Biome.HAN_FIBER_SPAWN)
            ...
            this.tag(TCOTS_Tags.Biome.CROWS_EYE_SPAWN)
                    .addOptionalTag(BiomeTags.IS_TAIGA.location())
                    .add(Biomes.GROVE)
            ;

            this.tag(TCOTS_Tags.Biome.ARENARIA_SPAWN)
                    .addOptionalTag(BiomeTags.IS_TAIGA.location())
                    .add(Biomes.FLOWER_FOREST)
            ;

            this.tag(TCOTS_Tags.Biome.PUFFBALL_SPAWN_NORMAL)
                    .add(Biomes.PLAINS)
            ...
            this.tag(TCOTS_Tags.Biome.PUFFBALL_SPAWN_TAIGA)
                    .add(Biomes.TAIGA).add(Biomes.SNOWY_TAIGA)
            ;

            this.tag(TCOTS_Tags.Biome.PUFFBALL_SPAWN_SWAMP)
                    .addOptionalTag(BiomeTags.HAS_RUINED_PORTAL_SWAMP.location())
            ;

            this.tag(TCOTS_Tags.Biome.MUSHROOM_SPAWN_OLD_GROWTH)
                    .add(Biomes.OLD_GROWTH_SPRUCE_TAIGA).add(Biomes.OLD_GROWTH_PINE_TAIGA)
            ;

            this.tag(TCOTS_Tags.Biome.SEWANT_SPAWN_NORMAL)
                    .add(Biomes.PLAINS)
                    .add(Biomes.SUNFLOWER_PLAINS)
                    .add(Biomes.SNOWY_PLAINS)
                    .add(Biomes.ICE_SPIKES)
            ...
            this.tag(TCOTS_Tags.Biome.SEWANT_SPAWN_TAIGA)
                    .add(Biomes.TAIGA)
            ;

            this.tag(TCOTS_Tags.Biome.SEWANT_SPAWN_DARK)
                    .add(Biomes.DARK_FOREST)
            ;
        }
        ...
        //Has_Monster
        {
            //Necrophages
            {
                //Drowners
                {
                    this.tag(TCOTS_Tags.Biome.DROWNER_SWAMP)
                            .addOptionalTag(BiomeTags.HAS_RUINED_PORTAL_SWAMP.location());

                    this.tag(TCOTS_Tags.Biome.DROWNER_BEACH)
                            .addOptionalTag(BiomeTags.IS_BEACH.location());

                    this.tag(TCOTS_Tags.Biome.DROWNER_WATER)
                ...
                //Rotfiends
                {
                    this.tag(TCOTS_Tags.Biome.ROTFIEND)
                ...
                //Foglets
                {
                    this.tag(TCOTS_Tags.Biome.FOGLET_SWAMP)
                            .addOptionalTag(BiomeTags.HAS_RUINED_PORTAL_SWAMP.location())
                            .add(Biomes.RIVER);

                    this.tag(TCOTS_Tags.Biome.FOGLET_DARK)
                            .addOptionalTag(BiomeTags.HAS_WOODLAND_MANSION.location());

                    this.tag(TCOTS_Tags.Biome.FOGLET_HILLS_FORESTS)
                            .add(Biomes.OLD_GROWTH_PINE_TAIGA).add(Biomes.OLD_GROWTH_SPRUCE_TAIGA)
                ...
                //Water Hags
                {
                    this.tag(TCOTS_Tags.Biome.WATER_HAG_SWAMP)
                            .addOptionalTag(BiomeTags.HAS_RUINED_PORTAL_SWAMP.location());

                    this.tag(TCOTS_Tags.Biome.WATER_HAG_RIVER)
                            .add(Biomes.RIVER);
                }
                ...
                //Grave Hags
                {
                    ...
                    this.tag(TCOTS_Tags.Biome.GRAVE_HAG)
                            .add(Biomes.BIRCH_FOREST).add(Biomes.FOREST).add(Biomes.DARK_FOREST)
                            .add(Biomes.DRIPSTONE_CAVES)
                            .add(Biomes.OLD_GROWTH_PINE_TAIGA).add(Biomes.OLD_GROWTH_SPRUCE_TAIGA)
                ...
                //Ghouls & Alghouls
                {
                    this.tag(TCOTS_Tags.Biome.GHOUL)
                ...
                //Scurvers
                {
                    this.tag(TCOTS_Tags.Biome.SCURVER)
                            .add(Biomes.BIRCH_FOREST).add(Biomes.FOREST).add(Biomes.DARK_FOREST)
                            .addOptionalTag(BiomeTags.HAS_VILLAGE_SAVANNA.location())
                            .addOptionalTag(BiomeTags.IS_JUNGLE.location());
                }
                ...
                //Devourer
                {
                    this.tag(TCOTS_Tags.Biome.DEVOURER)
                ...
                //Bloedzuiger
                {
                    this.tag(TCOTS_Tags.Biome.BLOEDZUIGER)
                            .addOptionalTag(BiomeTags.HAS_RUINED_PORTAL_SWAMP.location());
                }

                //Graveir
                {
                    this.tag(TCOTS_Tags.Biome.GRAVEIR)
                            .add(Biomes.PLAINS)
                            .add(Biomes.SUNFLOWER_PLAINS)
                            .add(Biomes.SNOWY_PLAINS)
                            .add(Biomes.ICE_SPIKES)
            ...
            //Ogroids
            {
                //Nekkers
                {
                    this.tag(TCOTS_Tags.Biome.NEKKER)
                            .add(Biomes.SAVANNA).add(Biomes.PLAINS)
                            .addOptionalTag(BiomeTags.IS_JUNGLE.location())
                ...
                //Cyclops
                {
                    this.tag(TCOTS_Tags.Biome.CYCLOPS)
                            .add(Biomes.SNOWY_PLAINS)
                            .add(Biomes.STONY_SHORE)
                            .addOptionalTag(BiomeTags.IS_HILL.location())
                ...
                //Rock Troll
                {
                    this.tag(TCOTS_Tags.Biome.ROCK_TROLL)
                ...
                //Ice Troll
                {
                    this.tag(TCOTS_Tags.Biome.ICE_TROLL)
                            .add(Biomes.SNOWY_PLAINS)
                            .add(Biomes.ICE_SPIKES)
                            .add(Biomes.SNOWY_TAIGA)
                            .add(Biomes.FROZEN_PEAKS)
                ...
                //Forest Troll
                {
                    this.tag(TCOTS_Tags.Biome.FOREST_TROLL)
                            .addOptionalTag(BiomeTags.IS_FOREST.location());
                }
            }
        }
        ...
        //Has_Structure
        {
            this.tag(TCOTS_Tags.Biome.GHOUL_NEST)
                    .add(Biomes.WOODED_BADLANDS)
            ...
            this.tag(TCOTS_Tags.Biome.NEKKER_NEST)
                    .add(Biomes.WOODED_BADLANDS)
            ...
            this.tag(TCOTS_Tags.Biome.ROCK_TROLL_CAVE)
                    .add(Biomes.STONY_PEAKS)
                    .add(Biomes.MEADOW)
                    .add(Biomes.WINDSWEPT_HILLS)
                    .add(Biomes.WINDSWEPT_FOREST)
            ...
            this.tag(TCOTS_Tags.Biome.ICE_TROLL_CAVE)
                    .add(Biomes.JAGGED_PEAKS)
                    .add(Biomes.FROZEN_PEAKS)
                    .add(Biomes.GROVE)
                    .add(Biomes.SNOWY_SLOPES);

            this.tag(TCOTS_Tags.Biome.FOREST_TROLL_CAVE)
                    .addOptionalTag(BiomeTags.IS_FOREST.location());

            this.tag(TCOTS_Tags.Biome.ICE_GIANT_CAVE)
                    .add(Biomes.JAGGED_PEAKS)
                    .add(Biomes.FROZEN_PEAKS)
                    .add(Biomes.SNOWY_SLOPES);
        }
