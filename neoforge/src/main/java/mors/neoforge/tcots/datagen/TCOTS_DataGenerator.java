package mors.neoforge.tcots.datagen;

import mors.neoforge.tcots.datagen.providers.*;
...
public class TCOTS_DataGenerator {
    ...
    public static void gatherData(final GatherDataEvent event) {
        ...
        //Client
        {
            ...
            //Language File
            generator.addProvider(event.includeClient(), new TCOTS_LanguageFileGenerator(output));
        }
        ...
        //Server
        {
            ...
            generator.addProvider(event.includeServer(), new TCOTS_DynamicRecipesGenerator(event.getGenerator().getPackOutput()));
        }
    }
