...
public class TCOTS_ItemModelGenerator extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        //Armor
        {
            armor(TCOTS_Items.WARRIORS_LEATHER_HEAD.get());
        ...
        //Misc & Bolts
        {
            ...
            basicItem(TCOTS_Items.MANTICORE_SCHOOL_MEDALLION.get());
        }
    }
