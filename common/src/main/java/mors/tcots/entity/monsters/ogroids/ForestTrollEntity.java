...
import mors.tcots.client.geo.animation.entity.ogroid.ForestTrollAnimations;
...
public class ForestTrollEntity extends AbstractTrollEntity {
    ...
    public ForestTrollEntity(final EntityType<? extends AbstractTrollEntity> entityType, final Level world) {
    ...
    protected static final EntityDataAccessor<Boolean> NECK_WOOD = SynchedEntityData.defineId(ForestTrollEntity.class, EntityDataSerializers.BOOLEAN);
     ...
     */
    public void setClothing(final boolean value, final int select) {
        switch (select) {
            case 0:
            ...
            case 3:
                ...
                break;
            case 4:
                this.entityData.set(NECK_WOOD, value);
                break;
            default:
                break;
        }
     ...
     * @param select Select the clothing: BandRightUp (0), BandLeftUp (1), Crown (2), Barrel (3), NeckBone (4)
     */
    public boolean getClothing(final int select) {
        return switch (select) {
            ...
            case 4 -> this.entityData.get(NECK_WOOD);
            default -> false;
        };
    }
    ...
    protected void defineSynchedData(final SynchedEntityData.@NotNull Builder builder) {
        ...
        builder.define(NECK_WOOD, Boolean.FALSE);
    ...
    @Nullable
    @Override
    public SpawnGroupData finalizeSpawn(final @NotNull ServerLevelAccessor world, final @NotNull DifficultyInstance difficulty, final @NotNull MobSpawnType spawnReason, @Nullable final SpawnGroupData entityData) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal_ForestTroll(this, 1.2D, false, 80));
    ...
    protected static class ReturnToHomePosition extends Goal {
        ...
        public ReturnToHomePosition(final ForestTrollEntity troll, final double speed, final double distanceBeforeReturning) {
            this.troll = troll;
            this.speed = speed;
    ...
    private static class MeleeAttackGoal_ForestTroll extends MeleeAttackGoal_Animated {
        ...
        public MeleeAttackGoal_ForestTroll(final ForestTrollEntity mob, final double speed, final boolean pauseWhenMobIdle, final int chargeCooldown) {
        ...
        public void tick() {
            ...
            //Charging Attack
            {
                ...
                final Vec3 monsterPosition = this.troll.position();
                final Vec3 monsterLookVec = this.troll.calculateViewVector(0.0f, troll.getYHeadRot()); // This gives the direction the monster is facing
                ...
                if (this.troll.distanceTo(target) > 8 && !this.troll.chargeCooldown && !this.troll.isCharging() && isFacingTarget) {
                    ...
                    if (this.pathCharge == null) return;
                ...
                if (troll.isCharging()) {
                    ...
                    this.troll.getNavigation().moveTo(this.pathCharge, this.speed);
    ...
    public void setIsCharging(final boolean wasCharging) {
    ...
    public void tick() {
        ...
        if(chargeCooldownTimer>0) --chargeCooldownTimer;
        else if (chargeCooldown) chargeCooldown=false;
    ...
    public void aiStep() {
        ...
        if (this.horizontalCollision && this.level().getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)) {
            boolean bl = false;
            final AABB box = this.getBoundingBox().inflate(0.2);
    ...
    protected void customServerAiStep() {
        ...
        if(this.isCharging()) TCOTS_EntitiesUtil.pushAndDamageEntities(this, 10f, 1.1, 1.1, 1.2D, ForestTrollEntity.class);

        if(this.getHealth()<this.getMaxHealth() && this.tickCount%60==0) this.heal(1);
    }
    ...
    public void addAdditionalSaveData(final @NotNull CompoundTag nbt) {
        ...
        final CompoundTag nbtClothing = new CompoundTag();
    ...
    public void readAdditionalSaveData(final @NotNull CompoundTag nbt) {
        ...
        final CompoundTag nbtClothing = nbt.getCompound("Clothing");
        ...
        final int x = nbt.getInt("HomePosX");
        final int y = nbt.getInt("HomePosY");
        final int z = nbt.getInt("HomePosZ");
        this.setHomePos(new BlockPos(x, y, z));
    }

    @Override
    protected ResourceKey<LootTable> getTrollLootTable() {
        return TCOTS_Entities.FOREST_TROLL_BARTERING;
    }
    ...
    @Override
    public void onReputationEventFrom(final @NotNull ReputationEventType interaction, final @NotNull Entity entity) {
    ...
    public void registerControllers(final AnimatableManager.ControllerRegistrar controllerRegistrar) {
        controllerRegistrar.add(ForestTrollAnimations.mainController(this));
    }
    ...
    public boolean blockedByArm(final DamageSource source) {
        final Vec3 attackSourcePosVector;
        ...
        if (!source.is(DamageTypeTags.BYPASSES_SHIELD) && !hasPiercing && (attackSourcePosVector = source.getSourcePosition()) != null) {
            final Vec3 rotationVector = this.calculateViewVector(0.0f, this.getYHeadRot());
