...
import mors.tcots.client.geo.animation.entity.necrophage.WaterHagAnimations;
...
import mors.tcots.entity.misc.WaterHag_MudBallEntity;
...
public class WaterHagEntity extends NecrophageMonster implements GeoEntity, RangedAttackMob, ExcavatorMob {
    ...
    public void performRangedAttack(final LivingEntity target, final float pullProgress) {
        ...
        this.triggerAnim("base_controller", "mud_attack");
    ...
    public void registerControllers(final AnimatableManager.ControllerRegistrar controllers) {
        //Main Controller
        controllers.add(WaterHagAnimations.mainController(this));
