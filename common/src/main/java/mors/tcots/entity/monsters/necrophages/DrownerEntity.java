...
import mors.tcots.client.geo.animation.entity.necrophage.DrownerAnimations;
...
//                }
        ...
        private void WaterAttackLogic(final LivingEntity target) {
            if(!drowner.hasAttackedOnWater) {
                ...
                if (this.canAttack(target)) {
                    ...
                    if (randomAttack == 0) {
                        drowner.triggerAnim("base_controller", "water_attack1");
                    } else {
                        drowner.triggerAnim("base_controller", "water_attack2");
                    }
    ...
    public void registerControllers(final AnimatableManager.ControllerRegistrar controllerRegistrar) {
        ...
        //Main Controller
        controllerRegistrar.add(DrownerAnimations.mainController(this));
