...
import mors.tcots.client.geo.model.entity.necrophage.AlghoulModel;
...
public class AlghoulRenderer extends GeoEntityRenderer<AlghoulEntity> {
    ...
    public AlghoulRenderer(final EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new GeoRenderLayer<>(this) {
            private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "textures/entity/monster/necrophage/alghoul/alghoul_regen_layer.png");
        ...
        //Spikes layer
        addRenderLayer(new GeoRenderLayer<>(this) {
            private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "textures/entity/monster/necrophage/alghoul/alghoul_spikes_layer.png");
