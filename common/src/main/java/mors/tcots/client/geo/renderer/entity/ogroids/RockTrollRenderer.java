...
import mors.tcots.client.geo.model.entity.ogroid.RockTrollModel;
...
public class RockTrollRenderer extends GeoEntityRenderer<RockTrollEntity> {
    public static final ResourceLocation RABID_EYES_TEXTURE = ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "textures/entity/monster/ogroid/troll_rabid.png");
        ...
        addRenderLayer(new GeoRenderLayer<>(this) {
            ...
            public void render(final PoseStack poseStack, final RockTrollEntity animatable, final BakedGeoModel bakedModel, final RenderType renderType, final MultiBufferSource bufferSource, final VertexConsumer buffer, final float partialTick, final int packedLight, final int packedOverlay) {
                if(animatable.isRabid()){
                    final RenderType armorRenderType = RenderType.armorCutoutNoCull(RABID_EYES_TEXTURE);
