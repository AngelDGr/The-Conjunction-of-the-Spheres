...
import mors.tcots.client.geo.model.entity.necrophage.GhoulModel;
...
public class GhoulRenderer extends GeoEntityRenderer<GhoulEntity> {
    ...
    public GhoulRenderer(final EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new GeoRenderLayer<>(this) {
            private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "textures/entity/monster/necrophage/ghoul/ghoul_regen_layer.png");
