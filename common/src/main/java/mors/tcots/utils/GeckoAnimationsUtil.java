...
public class GeckoAnimationsUtil {
    ...
    public static final RawAnimation CHARGE = RawAnimation.begin().thenLoop("move.charge");
    ...
    public static <T extends GeoAnimatable> AnimationController<?> attackController(final T animatable, final int attacks){
        if(attacks==2){
            ...
            return new AnimationController<>(animatable, "AttackController", 1, state -> PlayState.STOP)
                    .triggerableAnim("attack1", GeckoAnimationsUtil.ATTACK1)
                    .triggerableAnim("attack2", GeckoAnimationsUtil.ATTACK2)
                    .triggerableAnim("attack3", GeckoAnimationsUtil.ATTACK3);
        }
    }
