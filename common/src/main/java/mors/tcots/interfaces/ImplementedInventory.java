 ...
 * Use {@link ContainerHelper#saveAllItems(CompoundTag, NonNullList, boolean, HolderLookup.Provider)} (CompoundTag, NonNullList)} and {@link ContainerHelper#loadAllItems(CompoundTag, NonNullList, HolderLookup.Provider)}
