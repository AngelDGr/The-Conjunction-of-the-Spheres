...
public class WitcherMonsterOil_Base extends Item {
    ...
    public WitcherMonsterOil_Base(final Properties settings, final MonsterOilType group, final int uses, final int level) {
        ...
        againstDescription = Component.translatable("item.tcots_witcher.oil.against", Component.translatable(group.getTranslationKey())).withStyle(ChatFormatting.GRAY);
    ...
    public void appendHoverText(@NotNull final ItemStack stack, @NotNull final TooltipContext context, final List<Component> tooltip, @NotNull final TooltipFlag type) {
        ...
        //  +2 Attack Damage
        tooltip.add(CommonComponents.space().append(Component.translatable("item.tcots_witcher.oil.attack", extraDamage)).withStyle(ChatFormatting.BLUE));
        //Duration:
        tooltip.add(Component.translatable("item.tcots_witcher.oil.duration").withStyle(ChatFormatting.GRAY));
        //  60 Hits
        tooltip.add(CommonComponents.space().append(Component.translatable("item.tcots_witcher.oil.uses", getUses()).withStyle(ChatFormatting.BLUE)));
    }
