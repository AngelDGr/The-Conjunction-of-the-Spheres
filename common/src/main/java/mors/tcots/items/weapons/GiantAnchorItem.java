...
import mors.tcots.client.geo.renderer.item.GiantAnchorItemRenderer;
...
public class GiantAnchorItem extends TieredItem implements GeoItem {
    ...
    public static void retrieveAnchor(@NotNull final LivingEntity thrower){
        final AnchorProjectileEntity anchorProjectile= (AnchorProjectileEntity) thrower.tcots$getAnchor();
    ...
    public void inventoryTick(@NotNull final ItemStack anchorStack, @NotNull final Level world, @NotNull final Entity entity, final int slot, final boolean selected) {
        if(entity instanceof final LivingEntity livingEntity){
            this.hidden = livingEntity.tcots$getAnchor()!=null;
        }

        if(entity instanceof final LivingEntity livingEntity && livingEntity.tcots$getAnchor()!=null){
            anchorStack.set(TCOTS_Items.AnchorRetrieve(), true);
        } else if (entity instanceof final LivingEntity livingEntity && livingEntity.tcots$getAnchor()==null) {
    ...
    public void registerControllers(final ContextAwareAnimatableManager.ControllerRegistrar controllers) {
        controllers.add(GeckoAnimationsUtil.genericIdleController(this).triggerableAnim("idle", GeckoAnimationsUtil.IDLE));
    }
