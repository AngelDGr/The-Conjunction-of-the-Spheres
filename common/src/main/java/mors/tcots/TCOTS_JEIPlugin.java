...
import mors.tcots.registry.TCOTS_ItemsMaterials;
import mors.tcots.items.components.RecipeTeacherComponent;
import mors.tcots.recipes.AlchemyTableRecipe;
import mors.tcots.recipes.HerbalTableRecipe;
import mors.tcots.client.screen.HerbalTableScreen;
...
public class TCOTS_JEIPlugin implements IModPlugin {
    ...
    private static class RepairDataMaker {
        ...
        private static Stream<RepairData> getRepairData() {
            return Stream.of(
                    new RepairData(TCOTS_ItemsMaterials.Tool.GVALCHIR.getRepairIngredient(),
                            new ItemStack(TCOTS_Items.GVALCHIR.get())),

                    new RepairData(TCOTS_ItemsMaterials.Tool.MOONBLADE.getRepairIngredient(),
                            new ItemStack(TCOTS_Items.MOONBLADE.get())),

                    new RepairData(TCOTS_ItemsMaterials.Tool.DYAEBL.getRepairIngredient(),
                            new ItemStack(TCOTS_Items.DYAEBL.get())),

                    new RepairData(TCOTS_ItemsMaterials.Tool.WINTERS_BLADE.getRepairIngredient(),
                            new ItemStack(TCOTS_Items.WINTERS_BLADE.get())),

                    new RepairData(TCOTS_ItemsMaterials.Tool.ARDAENYE.getRepairIngredient(),
                            new ItemStack(TCOTS_Items.ARDAENYE.get())),

                    new RepairData(TCOTS_ItemsMaterials.Tool.ANCHOR.getRepairIngredient(),
                            new ItemStack(TCOTS_Items.GIANT_ANCHOR.get())),

                    new RepairData(TCOTS_ItemsMaterials.Armor.MANTICORE.value().repairIngredient().get(),
                            new ItemStack(TCOTS_Items.MANTICORE_HEAD.get()),
                    ...
                    new RepairData(TCOTS_ItemsMaterials.Armor.WARRIORS_LEATHER.value().repairIngredient().get(),
                            new ItemStack(TCOTS_Items.WARRIORS_LEATHER_HEAD.get()),
                    ...
                    new RepairData(TCOTS_ItemsMaterials.Armor.RAVEN.value().repairIngredient().get(),
                            new ItemStack(TCOTS_Items.RAVENS_HEAD.get()),
