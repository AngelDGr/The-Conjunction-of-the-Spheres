...
public class Foglet_FogParticleAround extends TextureSheetParticle {
    ...
    private Foglet_FogParticleAround(final ClientLevel world, final double x, final double y, final double z, final double velocityX, final double velocityY, final double velocityZ, final SpriteSet spriteProvider) {
