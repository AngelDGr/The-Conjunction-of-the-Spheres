...
public class MoonDust_ExplosionEmitterParticle extends NoRenderParticle {
    ...
    MoonDust_ExplosionEmitterParticle(final ClientLevel clientWorld, final double d, final double e, final double f) {
    ...
    public void tick() {
        for (int i = 0; i < 8; ++i) {
            ...
            if (random==1) {
                this.level.addParticle(ParticleTypes.ELECTRIC_SPARK, d, e, f, 0, 0.1, 0.0);
            } else {
