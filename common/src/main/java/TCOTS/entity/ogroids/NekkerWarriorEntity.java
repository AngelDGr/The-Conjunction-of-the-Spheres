...
public class NekkerWarriorEntity extends NekkerEntity implements GeoEntity {
    ...
    public NekkerWarriorEntity(EntityType<? extends NekkerEntity> entityType, Level world) {
    ...
    public boolean doHurtTarget(Entity target) {
        ...
        if(target instanceof Player player && player.isBlocking() && this.getRandom().nextInt()%10==0){
