...
public class RockTrollEntity extends AbstractTrollEntity implements RangedAttackMob {
    ...
    public RockTrollEntity(EntityType<? extends AbstractTrollEntity> entityType, Level world) {
    ...
    public void performRangedAttack(@NotNull LivingEntity target, float pullProgress) {
        ...
        Troll_RockProjectileEntity rockProjectileEntity = new Troll_RockProjectileEntity(this.level(), this, 8);
    ...
    public boolean hurt(@NotNull DamageSource source, float amount) {
        if(blockedByBack(source)
                &&
                !(source.getEntity()!=null && source.getEntity() instanceof LivingEntity attacker && attacker.getMainHandItem().getItem() instanceof PickaxeItem))
        {
    ...
    @Override
    public void onReputationEventFrom(@NotNull ReputationEventType interaction, @NotNull Entity entity) {
