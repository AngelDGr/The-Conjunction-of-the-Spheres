...
public class NekkerWarriorModel extends BipedGeoModelBase<NekkerWarriorEntity> {
    @Override
    public ResourceLocation getModelResource(NekkerWarriorEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "geo/ogroids/nekker_warrior.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(NekkerWarriorEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "textures/entity/ogroids/nekker/nekker_warrior.png");
    }

    @Override
    public ResourceLocation getAnimationResource(NekkerWarriorEntity animatable) {
