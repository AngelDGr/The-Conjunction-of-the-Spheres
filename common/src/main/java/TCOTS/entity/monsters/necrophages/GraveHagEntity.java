...
public class GraveHagEntity extends NecrophageMonster implements GeoEntity {
    ...
    private static class GraveHag_MeleeAttackGoal extends Goal{
        ...
        public GraveHag_MeleeAttackGoal(final GraveHagEntity graveHag, final double speed, final boolean pauseWhenMobIdle, final int timeBetweenTongueAttacks, final float damageWithTongue, final int timeBetweenRunningAttacks, final float speedMultiplierWhenRun) {
    ...
    public final void setIsRunning(final boolean wasRunning) {
