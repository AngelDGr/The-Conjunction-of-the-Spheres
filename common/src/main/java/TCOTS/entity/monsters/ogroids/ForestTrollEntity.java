...
public class ForestTrollEntity extends AbstractTrollEntity {
    ...
    @Nullable
    @Override
    public SpawnGroupData finalizeSpawn(final ServerLevelAccessor world, final DifficultyInstance difficulty, final MobSpawnType spawnReason, @Nullable final SpawnGroupData entityData) {
    ...
    private static class MeleeAttackGoal_ForestTroll extends MeleeAttackGoal_Animated {
        ...
        public MeleeAttackGoal_ForestTroll(final ForestTrollEntity mob, final double speed, final boolean pauseWhenMobIdle, final double speedMultiplier, final int chargeCooldown) {
