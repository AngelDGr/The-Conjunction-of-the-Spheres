...
![](tcots_witcher:textures/gui/sprites/alchemy_almanac/entries/refilling/refilling_bottle.png,fit)

;;;;;

In the two cases, you need to have [alcohol](^tcots_witcher:alchemy_basics/basic_ingredients).
