```json
{
  ...
  "associated_items": [
    ...
    "tcots_witcher:white_raffards_decoction",
    "tcots_witcher:cat_potion",
    "tcots_witcher:black_blood_potion",
    "tcots_witcher:maribor_forest_potion"
  ]
}
```
...
![](tcots_witcher:textures/gui/sprites/alchemy_almanac/entries/potions/potions_main.png,fit)

;;;;;

They can also be *[refilled](^tcots_witcher:alchemy_basics/refilling)*, so if you conserve the bottle,
...
because they are significantly stronger, they have [toxicity levels](^tcots_witcher:alchemy_basics/toxicity)
...
![](tcots_witcher:textures/gui/sprites/alchemy_almanac/entries/potions/potions_splash.png,fit)
