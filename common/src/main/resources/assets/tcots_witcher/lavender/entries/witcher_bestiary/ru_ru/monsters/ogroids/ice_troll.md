```json
{
  ...
  "icon_sprite": "tcots_witcher:witcher_bestiary/category/monsters/ogroids/ice_troll",
...
Несмотря на то, что есть несколько случаев, указывающих на то, что некоторым людям удалось [подружиться](^tcots_witcher:misc/befriending_troll) с этими чудовищами.
