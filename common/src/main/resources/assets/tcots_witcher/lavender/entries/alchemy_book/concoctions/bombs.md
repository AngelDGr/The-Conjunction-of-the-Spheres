...
Similar to [potions](^tcots_witcher:concoctions/potions), each type of bomb has three
levels;  *Normal*, *Enhanced* and *Superior*.

;;;;;

Once they are used, you can use the remaining powder to [remade them](^tcots_witcher:alchemy_basics/refilling).
