package fabric.TCOTS.world.village;

import TCOTS.TCOTS_Main;
import TCOTS.registry.TCOTS_WorldGen;
import net.minecraft.resources.ResourceLocation;
import fabric.TCOTS.structurized.impl.FabricStructurePoolRegistry;
...
//    turn_01       -> ^ 7  x5 ---> 1 [JIGSAW] 3 <---   // X
    public static void registerNewVillageStructures() {
        FabricStructurePoolRegistry.register(
                ...
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/plains/houses/herbalist_hut_1"),
                1,
        ...
        FabricStructurePoolRegistry.register(
                ResourceLocation.parse("minecraft:village/plains/houses"),
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/plains/houses/herbalist_hut_2"),
                2,
                TCOTS_WorldGen.RANDOM_HERBALIST_HERBS_PLAINS
        );
        ...
        FabricStructurePoolRegistry.register(
                ...
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/taiga/houses/herbalist_taiga_hut_1"),
                1,
        ...
        FabricStructurePoolRegistry.register(
                ResourceLocation.parse("minecraft:village/taiga/houses"),
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/taiga/houses/herbalist_taiga_hut_2"),
                2,
                TCOTS_WorldGen.RANDOM_HERBALIST_HERBS_TAIGA
        );
        ...
        FabricStructurePoolRegistry.register(
                ...
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/snowy/houses/herbalist_snowy_hut_1"),
                1,
        ...
        FabricStructurePoolRegistry.register(
                ResourceLocation.parse("minecraft:village/snowy/houses"),
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/snowy/houses/herbalist_snowy_hut_2"),
                2,
                TCOTS_WorldGen.RANDOM_HERBALIST_HERBS_SNOWY
        );
        ...
        FabricStructurePoolRegistry.register(
                ...
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/desert/houses/herbalist_desert_hut_1"),
                1,
        ...
        FabricStructurePoolRegistry.register(
                ResourceLocation.parse("minecraft:village/desert/houses"),
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/desert/houses/herbalist_desert_hut_2"),
                2,
                TCOTS_WorldGen.RANDOM_HERBALIST_HERBS_DESERT
        );
        ...
        FabricStructurePoolRegistry.register(
                ...
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/savanna/houses/herbalist_savanna_hut_1"),
                1,
        ...
        FabricStructurePoolRegistry.register(
                ResourceLocation.parse("minecraft:village/savanna/houses"),
                ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, "village/savanna/houses/herbalist_savanna_hut_2"),
                2,
                TCOTS_WorldGen.RANDOM_HERBALIST_HERBS_SAVANNA
        );
    }
