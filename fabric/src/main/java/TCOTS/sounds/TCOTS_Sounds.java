...
public class TCOTS_Sounds {
    ...
    public static Holder.Reference<SoundEvent> ROTFIEND_BLOOD_EXPLOSION = registerReference("rotfiend_blood_explosion");
    ...
    private static SoundEvent registerSoundEvent(String name) {
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID, name);
