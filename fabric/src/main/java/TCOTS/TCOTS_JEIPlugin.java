...
public class TCOTS_JEIPlugin implements IModPlugin {
    ...
    public static final RecipeType<RecipeHolder<AlchemyTableRecipe>> ALCHEMY_TABLE = RecipeType.createFromVanilla(AlchemyTableRecipe.Type.INSTANCE);
    public static final RecipeType<RecipeHolder<HerbalTableRecipe>> HERBAL_TABLE = RecipeType.createFromVanilla(HerbalTableRecipe.Type.INSTANCE);
    ...
    public void registerItemSubtypes(ISubtypeRegistration registration) {
        registration.registerSubtypeInterpreter(TCOTS_Items_Fabric.ALCHEMY_FORMULA, AlchemyFormulaInterpreter.INSTANCE);
    }
    ...
    public static class AlchemyFormulaInterpreter implements ISubtypeInterpreter<ItemStack> {
        ...
        public @Nullable Object getSubtypeData(ItemStack ingredient, @NotNull UidContext context) {
            return ingredient.get(TCOTS_Items_Fabric.RECIPE_TEACHER_COMPONENT);
        }

        @Override
        public @NotNull String getLegacyStringSubtypeInfo(ItemStack ingredient, @NotNull UidContext context) {
            if (!ingredient.has(TCOTS_Items_Fabric.RECIPE_TEACHER_COMPONENT)) {
                return "";
            }

            RecipeTeacherComponent recipeTeacher = ingredient.get(TCOTS_Items_Fabric.RECIPE_TEACHER_COMPONENT);
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(TCOTS_Blocks_Fabric.ALCHEMY_TABLE), ALCHEMY_TABLE);
        registration.addRecipeCatalyst(new ItemStack(TCOTS_Blocks_Fabric.HERBAL_TABLE), HERBAL_TABLE);
    }
    ...
    private static class AlchemyTableRecipeCategory implements IRecipeCategory<RecipeHolder<AlchemyTableRecipe>> {
        ...
        public AlchemyTableRecipeCategory(IGuiHelper guiHelper) {
            ...
            icon = guiHelper.createDrawableItemStack(new ItemStack(TCOTS_Blocks_Fabric.ALCHEMY_TABLE));
        }
        ...
        public @NotNull Component getTitle() {
            return TCOTS_Blocks_Fabric.ALCHEMY_TABLE.getName();
        }
        ...
        @Override
        public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull RecipeHolder<AlchemyTableRecipe> recipe, @NotNull IFocusGroup focuses) {
        ...
        @Override
        public void draw(@NotNull RecipeHolder<AlchemyTableRecipe> recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
            ...
            String text = Translator.translateToLocalFormatted("gui.jei.tcots_witcher.requires_recipe");
    ...
    private static class HerbalTableRecipeCategory implements IRecipeCategory<RecipeHolder<HerbalTableRecipe>> {
        ...
        public HerbalTableRecipeCategory(IGuiHelper guiHelper) {
            ...
            icon = guiHelper.createDrawableItemStack(new ItemStack(TCOTS_Blocks_Fabric.HERBAL_TABLE));
        }
        ...
        @Override
        public @NotNull Component getTitle() {
            return TCOTS_Blocks_Fabric.HERBAL_TABLE.getName();
        }
        ...
        @Override
        public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull RecipeHolder<HerbalTableRecipe> recipeEntry, @NotNull IFocusGroup focuses) {
            ...
            //Result
            List<MobEffectInstance> totalEffectsFirst = new ArrayList<>();
        ...
        @Override
        public void draw(@NotNull RecipeHolder<HerbalTableRecipe> recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
            IRecipeCategory.super.draw(recipe, recipeSlotsView, guiGraphics, mouseX, mouseY);
            Minecraft minecraft = Minecraft.getInstance();
            String text = Translator.translateToLocalFormatted("gui.jei.tcots_witcher.for_herb", recipe.value().getTickEffectTime()/20);
    ...
    private static class TCOTSRecipes {
        ...
        public List<RecipeHolder<AlchemyTableRecipe>> getAlchemyTableRecipes(IRecipeCategory<RecipeHolder<AlchemyTableRecipe>> alchemyTableCategory) {
        ...
        public List<RecipeHolder<HerbalTableRecipe>> getHerbalTableRecipes(IRecipeCategory<RecipeHolder<HerbalTableRecipe>> herbalTableCategory) {
        ...
        private static Stream<RepairData> getRepairData() {
            return Stream.of(
                    new RepairData(TCOTS_ToolMaterials.GVALCHIR.getRepairIngredient(),
                            new ItemStack(TCOTS_Items_Fabric.GVALCHIR)),

                    new RepairData(TCOTS_ToolMaterials.MOONBLADE.getRepairIngredient(),
                            new ItemStack(TCOTS_Items_Fabric.MOONBLADE)),

                    new RepairData(TCOTS_ToolMaterials.DYAEBL.getRepairIngredient(),
                            new ItemStack(TCOTS_Items_Fabric.DYAEBL)),

                    new RepairData(TCOTS_ToolMaterials.WINTERS_BLADE.getRepairIngredient(),
                            new ItemStack(TCOTS_Items_Fabric.WINTERS_BLADE)),

                    new RepairData(TCOTS_ToolMaterials.ARDAENYE.getRepairIngredient(),
                            new ItemStack(TCOTS_Items_Fabric.ARDAENYE)),

                    new RepairData(TCOTS_ToolMaterials.ANCHOR.getRepairIngredient(),
                            new ItemStack(TCOTS_Items_Fabric.GIANT_ANCHOR)),

                    new RepairData(TCOTS_ArmorMaterials.MANTICORE.value().repairIngredient().get(),
                            new ItemStack(TCOTS_Items_Fabric.MANTICORE_ARMOR),
                            new ItemStack(TCOTS_Items_Fabric.MANTICORE_TROUSERS),
                            new ItemStack(TCOTS_Items_Fabric.MANTICORE_BOOTS)),

                    new RepairData(TCOTS_ArmorMaterials.WARRIORS_LEATHER.value().repairIngredient().get(),
                            new ItemStack(TCOTS_Items_Fabric.WARRIORS_LEATHER_JACKET),
                            new ItemStack(TCOTS_Items_Fabric.WARRIORS_LEATHER_TROUSERS),
                            new ItemStack(TCOTS_Items_Fabric.WARRIORS_LEATHER_BOOTS)),

                    new RepairData(TCOTS_ArmorMaterials.RAVEN.value().repairIngredient().get(),
                            new ItemStack(TCOTS_Items_Fabric.RAVENS_ARMOR),
                            new ItemStack(TCOTS_Items_Fabric.RAVENS_TROUSERS),
                            new ItemStack(TCOTS_Items_Fabric.RAVENS_BOOTS)
                            )
            );
        }
