    ...
    protected void renderWidget(@NotNull GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        if(playerHasRecipe)
        {
            ...
            if (resultCount > 1) {
                ...
                context.drawString(textRenderer, String.valueOf(resultCount), this.getX() + 3, this.getY() + 11, 0xffffff, true);
                context.pose().popPose();
            }
                ...
                switch (l) {
                    case 0:
                        ...
                        if (number > 1) {
                            context.pose().pushPose();
                            context.pose().translate(0, 0, 200);
                            context.drawString(textRenderer, String.valueOf(number), this.getX() + 62, this.getY() + 11, textColor1, true);
                            context.pose().popPose();
                        }
                        break;
                    case 1:
                        ...
                        if (number > 1) {
                            context.pose().pushPose();
                            context.pose().translate(0, 0, 200);
                            context.drawString(textRenderer, String.valueOf(number), this.getX() + 43, this.getY() + 11, textColor2, true);
                            context.pose().popPose();
                        }
                        break;
                    case 2:
                        ...
                        if (number > 1) {
                            context.pose().pushPose();
                            context.pose().translate(0, 0, 200);
                            context.drawString(textRenderer, String.valueOf(number), this.getX() + 81, this.getY() + 11, textColor3, true);
                            context.pose().popPose();
                        }
                        break;
                    case 3:
                        ...
                        if (number > 1) {
                            context.pose().pushPose();
                            context.pose().translate(0, 0, 200);
                            context.drawString(textRenderer, String.valueOf(number), this.getX() + 24, this.getY() + 11, textColor4, true);
                            context.pose().popPose();
                        }
                        break;
                    case 4:
                        ...
                        if (number > 1) {
                            context.pose().pushPose();
                            context.pose().translate(0, 0, 200);
                            context.drawString(textRenderer, String.valueOf(number), this.getX() + 100, this.getY() + 11, textColor5, true);
                            context.pose().popPose();
                        }
                        break;
            ...
            if (baseCount > 1) {
                context.pose().pushPose();
                context.pose().translate(0, 0, 200);
                context.drawString(textRenderer, String.valueOf(baseCount), this.getX() + 119, this.getY() + 11, textColorBase, true);
                context.pose().popPose();
            }
        }
    }
