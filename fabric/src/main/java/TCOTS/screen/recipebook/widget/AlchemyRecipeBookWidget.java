...
//        this.cachedInvBlockChangeCount = craftingScreenHandler.getChangeCount();
    ...
    public void reset(){
        ...
        if(this.tabButtons.isEmpty()){
            //Potions
            this.tabButtons.add(0,new AlchemyRecipeGroupButton(TCOTS_Items_Fabric.DWARVEN_SPIRIT.getDefaultInstance(), AlchemyTableRecipeCategory.POTIONS));
            //Decoctions
            this.tabButtons.add(1,new AlchemyRecipeGroupButton(TCOTS_Items_Fabric.GRAVE_HAG_DECOCTION.getDefaultInstance(), AlchemyTableRecipeCategory.DECOCTIONS));
            //Bombs
            this.tabButtons.add(2,new AlchemyRecipeGroupButton(TCOTS_Items_Fabric.GRAPESHOT.getDefaultInstance(), AlchemyTableRecipeCategory.BOMBS_OILS));
            //Misc
            this.tabButtons.add(3,new AlchemyRecipeGroupButton(TCOTS_Items_Fabric.AETHER.getDefaultInstance(), AlchemyTableRecipeCategory.MISC));
        }
