...
public class DragonsDream_ExplosionEmitterParticle extends NoRenderParticle {
    ...
    DragonsDream_ExplosionEmitterParticle(ClientLevel clientWorld, double d, double e, double f) {
    ...
    public void tick() {
        for (int i = 0; i < 8; ++i) {
            ...
            this.level.addParticle(TCOTS_Particles_Fabric.YELLOW_CLOUD, d, e, f, 0, 0.0, 0.0);
        }
        ++this.age;
