...
public class HerbalMixture extends PotionItem {
    ...
    public @NotNull ItemStack finishUsingItem(ItemStack stack, @NotNull Level world, @NotNull LivingEntity user) {
        ...
        if (!world.isClientSide) {
            CustomEffectsComponent customEffects = stack.getOrDefault(TCOTS_Items_Fabric.CUSTOM_EFFECTS_COMPONENT, CustomEffectsComponent.DEFAULT);
    ...
    public void appendHoverText(ItemStack stack, @NotNull TooltipContext context, @NotNull List<Component> tooltip, @NotNull TooltipFlag type) {
        CustomEffectsComponent customEffectsComponent = stack.get(TCOTS_Items_Fabric.CUSTOM_EFFECTS_COMPONENT);
