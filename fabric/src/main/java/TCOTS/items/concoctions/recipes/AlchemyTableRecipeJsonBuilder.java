...
public class AlchemyTableRecipeJsonBuilder {
    ...
    public static AlchemyTableRecipeJsonBuilder createMisc(float order, Item output, List<ItemStack> ingredients){
        return create(order, new ItemStack(output,2), AlchemyTableRecipeCategory.MISC, ingredients, TCOTS_Items_Fabric.WHITE_GULL);
    }
    ...
    public static AlchemyTableRecipeJsonBuilder createOil(float order, Item output, List<ItemStack> ingredients, int countSpecial, Item base) {
        ...
        return createDecoctionWithLevel(order, output, level, AlchemyTableRecipeCategory.BOMBS_OILS, ingredients, base, new ItemStack(TCOTS_Items_Fabric.MONSTER_FAT, countSpecial), new ItemStack(TCOTS_Items_Fabric.ALCHEMY_PASTE, countSpecial));
    }
    ...
    public static AlchemyTableRecipeJsonBuilder createBomb(float order, Item output, List<ItemStack> ingredients, Item base) {
        ...
        return createDecoctionWithLevel(order, output, level, AlchemyTableRecipeCategory.BOMBS_OILS, ingredients, base, TCOTS_Items_Fabric.STAMMELFORDS_DUST, TCOTS_Items_Fabric.ALCHEMISTS_POWDER);
    }
    ...
    public static AlchemyTableRecipeJsonBuilder createPotion(float order, Item output, List<ItemStack> ingredients) {
        return create(order, output, AlchemyTableRecipeCategory.POTIONS, ingredients, TCOTS_Items_Fabric.DWARVEN_SPIRIT);
    }
    ...
    public static AlchemyTableRecipeJsonBuilder createDecoction(float order, Item output, List<ItemStack> ingredients) {
        return create(order, output, AlchemyTableRecipeCategory.DECOCTIONS, ingredients, TCOTS_Items_Fabric.DWARVEN_SPIRIT);
    }
    ...
    public static AlchemyTableRecipeJsonBuilder createPotion(float order, Item output, int level, List<ItemStack> ingredients, Item base) {
        return createDecoctionWithLevel(order, output, level, AlchemyTableRecipeCategory.POTIONS, ingredients, base, TCOTS_Items_Fabric.ALCOHEST, TCOTS_Items_Fabric.WHITE_GULL);
    }
