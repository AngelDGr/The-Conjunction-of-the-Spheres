...
public class MoonDustBomb {
    ...
    public static void explosionLogic(WitcherBombEntity bomb){
        ...
        for(LivingEntity entity: list){
            ...
            entity.addEffect(new MobEffectInstance(TCOTS_Effects.MOON_DUST_EFFECT, bomb.getLevel() < 2 ? 200 : 400, bomb.getLevel()), entityCause);
    ...
    public static boolean checkOnlyEffect(LivingEntity entity){
        return entity.hasEffect(TCOTS_Effects.MOON_DUST_EFFECT);
    }
