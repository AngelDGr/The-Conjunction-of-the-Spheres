...
public class WaterHag_MudBallItem extends Item implements ProjectileItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand) {
        ...
        world.playSound(null, user.getX(), user.getY(), user.getZ(), TCOTS_Sounds.WATER_HAG_MUD_BALL_LAUNCH, SoundSource.NEUTRAL, 0.5f, 0.4f / (world.getRandom().nextFloat() * 0.4f + 0.8f));
