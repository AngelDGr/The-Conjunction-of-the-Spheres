package mors.fabric.tcots.world;
...
public class TCOTS_Structures {
    ...
    private static TagKey<Structure> generateTag(final String id) {
        return TagKey.create(Registries.STRUCTURE, ResourceLocation.fromNamespaceAndPath(TCOTS_Main.MOD_ID,id));
    }

    private static ResourceKey<Structure> generateStructureRegistry(final String id) {
