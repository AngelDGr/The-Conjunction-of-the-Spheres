...
public class ScreenHandlersAndRecipesRegister {
    ...
    public static void registerScreenHandlersAndRecipes()
    {
        ...
        HERBAL_TABLE_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, new Identifier(TCOTS_Main.MOD_ID, "herbal_table"),
                new ScreenHandlerType<>(HerbalTableScreenHandler::new, FeatureFlags.VANILLA_FEATURES));

        HERBAL_TABLE =
                Registry.register(Registries.RECIPE_TYPE, new Identifier(TCOTS_Main.MOD_ID, HerbalTableRecipe.ID_STRING),
                        //TypeInstance
                        HerbalTableRecipe.Type.INSTANCE);

        //RecipeSerializer
        Registry.register(Registries.RECIPE_SERIALIZER, new Identifier(TCOTS_Main.MOD_ID, HerbalTableRecipe.ID_STRING),
