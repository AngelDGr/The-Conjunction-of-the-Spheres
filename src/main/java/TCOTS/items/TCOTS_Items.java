...
public class TCOTS_Items {
    ...
    public static void registerDrops() {
        DROWNER_SPAWN_EGG = registerItem("drowner_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.DROWNER, 0x8db1c0, 0x9fa3ae, new Item.Settings()));
        ...
        ROTFIEND_SPAWN_EGG = registerItem("rotfiend_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.ROTFIEND, 0xb3867b, 0xe6e1bc, new Item.Settings()));
        ROTFIEND_BLOOD = registerItem("rotfiend_blood",
                new Item(new Item.Settings()));


        GRAVE_HAG_SPAWN_EGG = registerItem("grave_hag_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.GRAVE_HAG, 0xb6b692, 0x8e8480, new Item.Settings()));
        ...
        WATER_HAG_SPAWN_EGG = registerItem("water_hag_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.WATER_HAG, 0x8d93c0, 0x780b17, new Item.Settings()));
        WATER_HAG_MUD_BALL = registerItem("water_hag_mud_ball",
                new WaterHag_MudBallItem(new Item.Settings().maxCount(16)));
        ...
        FOGLET_SPAWN_EGG = registerItem("foglet_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.FOGLET, 0x4a3f3f, 0x211c1c, new Item.Settings()));
        ...
        GHOUL_SPAWN_EGG = registerItem("ghoul_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.GHOUL, 0xd69d76, 0x0e0a07, new Item.Settings()));
        ...
        SCURVER_SPAWN_EGG = registerItem("scurver_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.SCURVER, 0xc0887a, 0x661f1f, new Item.Settings()));

        SCURVER_SPINE = registerItem("scurver_spine",
                new ScurverSpineItem(new Item.Settings().maxCount(16)));


        DEVOURER_SPAWN_EGG = registerItem("devourer_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.DEVOURER, 0x606c68, 0x1f1f1f, new Item.Settings()));
        DEVOURER_TEETH = registerItem("devourer_teeth",
                new Item(new Item.Settings()));

        GRAVEIR_SPAWN_EGG = registerItem("graveir_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.GRAVEIR, 0xab706d, 0x882925, new Item.Settings()));
        ...
        BULLVORE_SPAWN_EGG = registerItem("bullvore_spawn_egg",
                new SpawnEggItem(TCOTS_Entities.BULLVORE, 0xdad29a, 0xb1816d, new Item.Settings()));
    ...
    public static void registerAlchemyConcoctions() {
        ...
        ALCHEMY_FORMULA = registerItem("alchemy_formula",
                new AlchemyFormulaItem(new Item.Settings().maxCount(1).rarity(Rarity.UNCOMMON))
        );
        ...
        {
            {
                EMPTY_WITCHER_POTION = registerItem("empty_witcher_potion",
                        new EmptyWitcherPotionItem(new Item.Settings())
                );

                EMPTY_WITCHER_POTION_2 = registerItem("empty_witcher_potion2",
                        new EmptyWitcherPotionItem(new Item.Settings().maxCount(2))
                );

                EMPTY_WITCHER_POTION_3 = registerItem("empty_witcher_potion3",
                        new EmptyWitcherPotionItem(new Item.Settings().maxCount(3))
                );

                EMPTY_WITCHER_POTION_4 = registerItem("empty_witcher_potion4",
                        new EmptyWitcherPotionItem(new Item.Settings().maxCount(4))
                );

                EMPTY_WITCHER_POTION_5 = registerItem("empty_witcher_potion5",
                        new EmptyWitcherPotionItem(new Item.Settings().maxCount(5))
                );

                //Swallow
                {
                    SWALLOW_POTION = registerItemPotion("swallow_potion",
                            new Item.Settings().maxCount(3),
                    ...
                    SWALLOW_POTION_ENHANCED = registerItemPotion("swallow_potion_enhanced",
                            new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON),
                            TCOTS_Effects.SWALLOW_EFFECT,
                            20,
                            20,
                            1,
                    ...
                    SWALLOW_POTION_SUPERIOR = registerItemPotion("swallow_potion_superior",
                            new Item.Settings().maxCount(5).rarity(Rarity.UNCOMMON),
                            TCOTS_Effects.SWALLOW_EFFECT,
                            20,
                            20,
                            2,
                ...
                //White Raffard's
                {
                    ...
                    WHITE_RAFFARDS_DECOCTION_ENHANCED = registerItemPotion("white_raffards_decoction_enhanced",
                            new Item.Settings().maxCount(2).rarity(Rarity.UNCOMMON),
                            TCOTS_Effects.WHITE_RAFFARDS_EFFECT,
                            25,
                            1,
                            1,
                    ...
                    WHITE_RAFFARDS_DECOCTION_SUPERIOR = registerItemPotion("white_raffards_decoction_superior",
                            new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON),
                            TCOTS_Effects.WHITE_RAFFARDS_EFFECT,
                            25,
                            1,
                            2,
                ...
                //White Honey
                {
                    WHITE_HONEY_POTION = registerItem("white_honey_potion",
                            new WitcherWhiteHoney(new Item.Settings().maxCount(1))
                    );

                    WHITE_HONEY_POTION_ENHANCED = registerItem("white_honey_potion_enhanced",
                            new WitcherWhiteHoney(new Item.Settings().maxCount(2).rarity(Rarity.UNCOMMON))
                    );

                    WHITE_HONEY_POTION_SUPERIOR = registerItem("white_honey_potion_superior",
                            new WitcherWhiteHoney(new Item.Settings().maxCount(5).rarity(Rarity.UNCOMMON))
                    );
                }
            }
            ...
            //Decoctions
            {
                EMPTY_MONSTER_DECOCTION = registerItem("empty_monster_decoction",
                        new EmptyWitcherPotionItem(new Item.Settings().maxCount(1))
                );
        ...
        //Bombs
        {
            EMPTY_BOMB_POWDER = registerItem("bomb_powder",
                    new EmptyBombPowderItem(new Item.Settings()));

            EMPTY_BOMB_POWDER_2 = registerItem("bomb_powder_2",
                    new EmptyBombPowderItem(new Item.Settings().maxCount(2)));

            EMPTY_BOMB_POWDER_3 = registerItem("bomb_powder_3",
                    new EmptyBombPowderItem(new Item.Settings().maxCount(3)));

            EMPTY_BOMB_POWDER_4 = registerItem("bomb_powder_4",
                    new EmptyBombPowderItem(new Item.Settings().maxCount(4)));


            GRAPESHOT = registerItem("grapeshot",
                    new WitcherBombs_Base(new Item.Settings().maxCount(2), "grapeshot", 0));

            GRAPESHOT_ENHANCED = registerItem("grapeshot_enhanced",
                    new WitcherBombs_Base(new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON), "grapeshot", 1));

            GRAPESHOT_SUPERIOR = registerItem("grapeshot_superior",
                    new WitcherBombs_Base(new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON), "grapeshot", 2));


            SAMUM = registerItem("samum",
                    new WitcherBombs_Base(new Item.Settings().maxCount(2), "samum", 0));

            SAMUM_ENHANCED = registerItem("samum_enhanced",
                    new WitcherBombs_Base(new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON), "samum", 1));

            SAMUM_SUPERIOR = registerItem("samum_superior",
                    new WitcherBombs_Base(new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON), "samum", 2));


            DANCING_STAR = registerItem("dancing_star",
                    new WitcherBombs_Base(new Item.Settings().maxCount(2), "dancing_star", 0));

            DANCING_STAR_ENHANCED = registerItem("dancing_star_enhanced",
                    new WitcherBombs_Base(new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON), "dancing_star", 1));

            DANCING_STAR_SUPERIOR = registerItem("dancing_star_superior",
                    new WitcherBombs_Base(new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON), "dancing_star", 2));


            DEVILS_PUFFBALL = registerItem("devils_puffball",
                    new WitcherBombs_Base(new Item.Settings().maxCount(2), "devils_puffball", 0));

            DEVILS_PUFFBALL_ENHANCED = registerItem("devils_puffball_enhanced",
                    new WitcherBombs_Base(new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON), "devils_puffball", 1));

            DEVILS_PUFFBALL_SUPERIOR = registerItem("devils_puffball_superior",
                    new WitcherBombs_Base(new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON), "devils_puffball", 2));


            NORTHERN_WIND = registerItem("northern_wind",
                    new WitcherBombs_Base(new Item.Settings().maxCount(2), "northern_wind", 0));

            NORTHERN_WIND_ENHANCED = registerItem("northern_wind_enhanced",
                    new WitcherBombs_Base(new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON), "northern_wind", 1));

            NORTHERN_WIND_SUPERIOR = registerItem("northern_wind_superior",
                    new WitcherBombs_Base(new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON), "northern_wind", 2));


            DRAGONS_DREAM = registerItem("dragons_dream",
                    new WitcherBombs_Base(new Item.Settings().maxCount(2), "dragons_dream", 0));

            DRAGONS_DREAM_ENHANCED = registerItem("dragons_dream_enhanced",
                    new WitcherBombs_Base(new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON), "dragons_dream", 1));

            DRAGONS_DREAM_SUPERIOR = registerItem("dragons_dream_superior",
                    new WitcherBombs_Base(new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON), "dragons_dream", 2));


            DIMERITIUM_BOMB = registerItem("dimeritium_bomb",
                    new WitcherBombs_Base(new Item.Settings().maxCount(2), "dimeritium_bomb", 0));

            DIMERITIUM_BOMB_ENHANCED = registerItem("dimeritium_bomb_enhanced",
                    new WitcherBombs_Base(new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON), "dimeritium_bomb", 1));

            DIMERITIUM_BOMB_SUPERIOR = registerItem("dimeritium_bomb_superior",
                    new WitcherBombs_Base(new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON), "dimeritium_bomb", 2));


            MOON_DUST = registerItem("moon_dust",
                    new WitcherBombs_Base(new Item.Settings().maxCount(2), "moon_dust", 0));

            MOON_DUST_ENHANCED = registerItem("moon_dust_enhanced",
                    new WitcherBombs_Base(new Item.Settings().maxCount(3).rarity(Rarity.UNCOMMON), "moon_dust", 1));

            MOON_DUST_SUPERIOR = registerItem("moon_dust_superior",
                    new WitcherBombs_Base(new Item.Settings().maxCount(4).rarity(Rarity.UNCOMMON), "moon_dust", 2));
        ...
        //Oils
        {
            ...
            NECROPHAGE_OIL = registerItem("oil_necrophage",
                    new WitcherMonsterOil_Base(new Item.Settings().maxCount(1).rarity(Rarity.COMMON),
                            WitcherMonsterOil_Base.MonsterOilType.NECROPHAGES,
                            20,
                            1)
            );
            ENHANCED_NECROPHAGE_OIL = registerItem("oil_necrophage_enhanced",
                    new WitcherMonsterOil_Base(new Item.Settings().maxCount(1).rarity(Rarity.UNCOMMON),
                            WitcherMonsterOil_Base.MonsterOilType.NECROPHAGES,
                            40,
                            2)
            );
    ...
    public static void registerWeapons_Armors(){
        ...
        //Ingredients
        {
            CURED_MONSTER_LEATHER=registerItem("cured_monster_leather", new Item(new Item.Settings()));
        }

        //Crossbows
        {
            KNIGHT_CROSSBOW = registerItem("knight_crossbow",
                    new KnightCrossbow(new Item.Settings().maxCount(1).maxDamage(600)));

            BASE_BOLT = registerItem("base_bolt", new BoltItem(new Item.Settings(), "base_bolt"));

            BLUNT_BOLT = registerItem("blunt_bolt", new BoltItem(new Item.Settings().maxCount(32), "blunt_bolt"));

            PRECISION_BOLT = registerItem("precision_bolt", new BoltItem(new Item.Settings().maxCount(32), "precision_bolt"));

            EXPLODING_BOLT = registerItem("exploding_bolt", new BoltItem(new Item.Settings().maxCount(32), "exploding_bolt"));

            BROADHEAD_BOLT = registerItem("broadhead_bolt", new BoltItem(new Item.Settings().maxCount(32), "broadhead_bolt"));
        }
        ...
        //Horse Armor
        {
            TUNDRA_HORSE_ARMOR = registerItem("tundra_horse_armor",
                    new WitcherHorseArmorItem(TCOTS_ArmorMaterials.TUNDRA, "tundra", new Item.Settings().maxCount(1),
                            List.of(
            ...
            KNIGHT_ERRANTS_HORSE_ARMOR = registerItem("knight_errants_horse_armor",
                    new WitcherHorseArmorItem(TCOTS_ArmorMaterials.KNIGHT, "knight_errants", new Item.Settings().maxCount(1),
                            List.of(
        ...
        //Misc
        {
            GIANT_ANCHOR=registerItem("giant_anchor", new GiantAnchorItem(new
                    ...
                    .attributeModifiers(SwordItem.createAttributeModifiers(TCOTS_ToolMaterials.ANCHOR, 1, -3.4f))));
    ...
    public static void registerAlchemyIngredients(){
        ...
        //Alcohol
        {
            ICY_SPIRIT = (WitcherAlcohol_Base) registerItem("icy_spirit",
                    new WitcherAlcohol_Base(new Item.Settings().maxCount(64),
                            Arrays.asList(
            ...
            DWARVEN_SPIRIT = (WitcherAlcohol_Base) registerItem("dwarven_spirit",
                    new WitcherAlcohol_Base(new Item.Settings().maxCount(16),
            ...
            WHITE_GULL = (WitcherAlcohol_Base) registerItem("white_gull",
                    new WitcherAlcohol_Base(new Item.Settings().maxCount(8),
                            Arrays.asList(
        ...
        //Plants
        {
            ...
            CROWS_EYE = registerItem("crows_eye",
                    new AliasedBlockItem(TCOTS_Blocks.CROWS_EYE_FERN,
                            new Item.Settings().food(new FoodComponent.Builder().nutrition(4).saturationModifier(1.2f).statusEffect(new StatusEffectInstance(StatusEffects.POISON, 100, 0), 0.8f).build())));
        ...
        LootTableEvents.MODIFY.register( (id, tableBuilder, source, wrapperLookup) ->{
            ...
            if(EntityType.RAVAGER.getLootTableId().equals(id) && source.isBuiltin()){
                LootPool.Builder monsterFat = LootPool.builder()
                        ...
                        .conditionally(RandomChanceWithEnchantedBonusLootCondition.builder(wrapperLookup,0.8f, 0.1f));
            ...
            if((EntityType.HOGLIN.getLootTableId().equals(id) || EntityType.ZOGLIN.getLootTableId().equals(id)) && source.isBuiltin()){
                LootPool.Builder monsterFat = LootPool.builder()
                        ...
                        .conditionally(KilledByPlayerLootCondition.builder())
                        .conditionally(RandomChanceWithEnchantedBonusLootCondition.builder(wrapperLookup ,0.4f, 0.1f));
            ...
            if(EntityType.POLAR_BEAR.getLootTableId().equals(id) && source.isBuiltin()){
                LootPool.Builder monsterFat = LootPool.builder()
                        ...
                        .conditionally(KilledByPlayerLootCondition.builder())
                        .conditionally(RandomChanceWithEnchantedBonusLootCondition.builder(wrapperLookup,0.3f, 0.1f));
            ...
            if(EntityType.PIGLIN_BRUTE.getLootTableId().equals(id) && source.isBuiltin()){
                LootPool.Builder monsterFat = LootPool.builder()
                        ...
                        .conditionally(KilledByPlayerLootCondition.builder())
                        .conditionally(RandomChanceWithEnchantedBonusLootCondition.builder(wrapperLookup, 0.25f, 0.1f));
    ...
    public static void registerItemsMisc(){
        ...
        NEST_SKULL_ITEM = registerItem("nest_skull", new NestSkullItem(TCOTS_Blocks.NEST_SKULL, TCOTS_Blocks.NEST_WALL_SKULL, new Item.Settings(), Direction.DOWN));

        MONSTER_NEST_ITEM = registerItem("monster_nest", new MonsterNestItem(TCOTS_Blocks.MONSTER_NEST, new Item.Settings()));

        ALCHEMY_TABLE_ITEM = registerItem("alchemy_table", new AlchemyTableItem(TCOTS_Blocks.ALCHEMY_TABLE, new Item.Settings()));

        HERBAL_TABLE_ITEM = registerItem("herbal_table", new HerbalTableItem(TCOTS_Blocks.HERBAL_TABLE, new Item.Settings()));

        HERBAL_MIXTURE = registerItem("herbal_mixture", new HerbalMixture(new Item.Settings().food(new FoodComponent.Builder().nutrition(2).saturationModifier(0.2f).alwaysEdible().build()).maxCount(2)));


        GIANT_ANCHOR_BLOCK_ITEM = registerItem("giant_anchor_block", new GiantAnchorBlockItem(TCOTS_Blocks.GIANT_ANCHOR, new Item.Settings()));

        WINTERS_BLADE_SKELETON_ITEM = registerItem("winters_blade_skeleton", new WintersBladeSkeletonItem(TCOTS_Blocks.WINTERS_BLADE_SKELETON, new Item.Settings()));

        SKELETON_BLOCK_ITEM = registerItem("skeleton_block", new SkeletonBlockItem(TCOTS_Blocks.SKELETON_BLOCK, new Item.Settings()));


        WITCHER_BESTIARY = WitcherBestiaryItem.registerForBook(Identifier.of(TCOTS_Main.MOD_ID, "witcher_bestiary"), new Item.Settings().maxCount(1));

        ALCHEMY_BOOK = AlchemyBookItem.registerForBook(Identifier.of(TCOTS_Main.MOD_ID, "alchemy_book"), new Item.Settings().maxCount(1));
    }

    public static final LootFunctionType<? extends ConditionalLootFunction> RANDOMIZE_FORMULA = register("randomize_formula", AlchemyRecipeRandomlyLootFunction.CODEC);

    @SuppressWarnings("all")
    private static LootFunctionType<? extends ConditionalLootFunction> register(String id, MapCodec<? extends LootFunction> codec) {
        return Registry.register(Registries.LOOT_FUNCTION_TYPE, Identifier.of(TCOTS_Main.MOD_ID,id), new LootFunctionType(codec));
    }
...
//        return Registry.register(Registries.ITEM, RegistryKey.of(Registries.ITEM.getKey(), Identifier.of(TCOTS_Main.MOD_ID, name)), item);
     ...
     */
    private static Item registerItemPotion(String name, Item.Settings settings, RegistryEntry<StatusEffect> effect, int toxicity, int durationInSecs, int amplifier, boolean decoction) {
        try {
            Identifier identifier = Identifier.of(TCOTS_Main.MOD_ID, name);
            StatusEffectInstance effectInstance = new StatusEffectInstance(effect, (int)(durationInSecs/0.05), amplifier);
    ...
    Creates a witcher potion of type decoction
     ...
     @param effect Decoction effect
    */
    private static Item registerItemPotion(String name, RegistryEntry<StatusEffect> effect) {
        return registerItemPotion(name, new Item.Settings().maxCount(1), effect, 50, 600, 0, true);
    }

    private static Item registerSplashPotion(String name, Item.Settings settings, RegistryEntry<StatusEffect> effect, int toxicity, int durationInSecs){
        try {
            Identifier identifier = Identifier.of(TCOTS_Main.MOD_ID, name);
    ...
    //Item Components
    public static final ComponentType<MonsterOilComponent> MONSTER_OIL_COMPONENT = register("monster_oil", builder -> builder.codec(MonsterOilComponent.CODEC));
    public static final ComponentType<Boolean> ANCHOR_RETRIEVE = register("anchor_retrieve", builder -> builder.codec(Codec.BOOL).packetCodec(PacketCodecs.BOOL));
    public static final ComponentType<RecipeTeacherComponent> RECIPE_TEACHER_COMPONENT = register("recipe_teacher", builder -> builder.codec(RecipeTeacherComponent.CODEC));
    public static final ComponentType<CustomEffectsComponent> CUSTOM_EFFECTS_COMPONENT = register("custom_effects", builder -> builder.codec(CustomEffectsComponent.CODEC));
    public static final ComponentType<String> REFILL_RECIPE = register("refill_recipe", builder -> builder.codec(Codec.STRING).packetCodec(PacketCodecs.STRING));
