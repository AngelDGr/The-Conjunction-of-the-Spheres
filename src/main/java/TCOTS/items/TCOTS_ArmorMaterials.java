...
public enum TCOTS_ArmorMaterials implements ArmorMaterial {
    MANTICORE("manticore", 20, Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
    ...
    TCOTS_ArmorMaterials(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Ingredient repairIngredientSupplier){
        this.name = name;
