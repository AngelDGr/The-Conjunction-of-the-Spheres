...
public class NorthernWind_ExplosionEmitterParticle extends NoRenderParticle {
    ...
    NorthernWind_ExplosionEmitterParticle(ClientWorld clientWorld, double d, double e, double f) {
    ...
    public void tick() {
        for (int i = 0; i < 12; ++i) {
            ...
            if (random==1) {
                this.world.addParticle(ParticleTypes.SNOWFLAKE, d, e, f, 0, 0.0, 0.0);
            } else {
