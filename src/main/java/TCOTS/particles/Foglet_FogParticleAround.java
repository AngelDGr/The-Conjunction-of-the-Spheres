...
public class Foglet_FogParticleAround extends SpriteBillboardParticle {
    ...
    private Foglet_FogParticleAround(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public float getSize(float tickDelta) {
        return this.scale
                *
                (20f-(this.age* ((float) 20/this.maxAge)));
    }
