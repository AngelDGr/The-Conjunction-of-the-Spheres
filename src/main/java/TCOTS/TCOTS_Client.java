...
//        TCOTS_Sounds.init();
        ...
        EntityRendererRegistry.register(TCOTS_Entities.DROWNER_PUDDLE, Drowner_Puddle_Renderer::new);
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.DROWNER_PUDDLE, Drowner_Puddle_Model::getTexturedModelData);
    }
}
