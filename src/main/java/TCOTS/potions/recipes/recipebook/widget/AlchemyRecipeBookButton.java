...
public class AlchemyRecipeBookButton extends PressableWidget {
    ...
    protected static final AlchemyRecipeBookButton.NarrationSupplier DEFAULT_NARRATION_SUPPLIER = textSupplier -> (MutableText)textSupplier.get();
    ...
    public static interface PressAction {
        public void onPress(AlchemyRecipeBookButton var1);
    }
