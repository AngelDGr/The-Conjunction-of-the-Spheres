...
//        ArrayList<RecipeAlchemyResultCollection> list2 = Lists.newArrayList(list);
...
//            AlchemyRecipeBookResults recipeResultCollection = this.recipesArea.getLastClickedResults();
