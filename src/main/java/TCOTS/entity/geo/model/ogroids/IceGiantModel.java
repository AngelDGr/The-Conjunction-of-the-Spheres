...
public class IceGiantModel extends BipedGeoModelBase<IceGiantEntity> {
    ...
    public Identifier getModelResource(IceGiantEntity animatable) {
        return Identifier.of(TCOTS_Main.MOD_ID, "geo/ogroids/ice_giant.geo.json");
    }

    @Override
    public Identifier getTextureResource(IceGiantEntity animatable) {
        if(animatable.isGiantSleeping() && !animatable.isGiantWakingUp()){
            return Identifier.of(TCOTS_Main.MOD_ID, "textures/entity/ogroids/ice_giant/ice_giant_sleeping.png");
        }

        return Identifier.of(TCOTS_Main.MOD_ID, "textures/entity/ogroids/ice_giant/ice_giant.png");
    }

    @Override
    public Identifier getAnimationResource(IceGiantEntity animatable) {
        return Identifier.of(TCOTS_Main.MOD_ID, "animations/ogroids/ice_giant.animation.json");
    }
