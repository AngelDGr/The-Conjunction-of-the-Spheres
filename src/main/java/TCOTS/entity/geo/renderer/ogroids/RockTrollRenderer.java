...
public class RockTrollRenderer extends GeoEntityRenderer<RockTrollEntity> {
    ...
    @Override
    public void preRender(MatrixStack poseStack, RockTrollEntity animatable, BakedGeoModel model, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
